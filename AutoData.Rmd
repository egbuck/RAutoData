...
```
We can get the summaries for these models
```{r}
# Get summary
summary(ldaModel)
summary(qdaModel)
...
ggplot(autoFrame, aes(x = displacement, y = mpg01)) + geom_point()
ggplot(autoFrame, aes(x = weight, y = mpg01)) + geom_point()
ggplot(autoFrame, aes(x = acceleration, y = mpg01)) + geom_point()
ggplot(autoFrame, aes(x = horsepower, y = mpg01)) + geom_point()
```
